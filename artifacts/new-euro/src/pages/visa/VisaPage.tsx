...
interface VisaPageProps {
  ...
  time: string;
  success: string;
  heroImgGradient: string;
  reqs: string[];
}

export default function VisaPage({ country, flag, types, time, success, heroImgGradient, reqs }: VisaPageProps) {
  return (
        ...
        <section className={`relative pt-32 pb-24 overflow-hidden border-b border-white/10 ${heroImgGradient}`}>
          ...
          <div className="container relative z-10 flex flex-col items-center text-center">
            ...
            <div className="flex gap-4">
              <Button size="lg" className="gold-gradient-bg text-black font-bold px-8">
        ...
        <div className="bg-card border-b border-white/5">
          <div className="container py-8 grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-white/10 text-center">
            ...
            <div className="flex flex-col items-center gap-2 py-4">
              ...
              <span className="text-2xl font-bold text-white text-center px-4">{types.join(" · ")}</span>
            </div>
          </div>
        </div>
